...
const IntroSection = () => {
  return (
    <section className="w-[76%] px-5 mx-auto text-white  flex flex-col justify-center gap-4">
      <Typography variant="h1">
        Welcome to My 3D Art{" "}
        <span className="text-customOrange-500">Portfolio.</span>
      </Typography>
      <Typography className=" md:block" variant="h2">
        Explore My <span className="text-customOrange-500">Blender</span>{" "}
        Creations
      </Typography>
      <Typography
      ...
      >
        ...
        <span className="text-customOrange-500">Blender</span> . Whether you're
